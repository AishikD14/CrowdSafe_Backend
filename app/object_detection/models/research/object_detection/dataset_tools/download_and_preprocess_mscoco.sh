...
#
# usage:
#  bash app.object_detection.models.research.object_detection/dataset_tools/download_and_preprocess_mscoco.sh \
#    /tmp/mscoco
set -e
...
cd "${CURRENT_DIR}"
python app.object_detection.models.research.object_detection/dataset_tools/create_coco_tf_record.py \
  --logtostderr \
  --include_masks \
