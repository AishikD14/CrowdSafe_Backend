...
Example usage:
  python app.object_detection.models.research.object_detection/dataset_tools/create_oid_tf_record.py \
...
from  app.object_detection.models.research.object_detectiondataset_tools import oid_tfrecord_creation
