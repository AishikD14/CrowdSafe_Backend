...
r"""Convert raw KITTI detection dataset to TFRecord for  app.object_detection.models.research.object_detection
...
Example usage:
    python app.object_detection.models.research.object_detection/dataset_tools/create_kitti_tf_record.py \
...
from  app.object_detection.models.research.object_detectionutils.np_box_ops import iou
