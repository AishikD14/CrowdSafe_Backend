...
in the app.object_detection.models.research.object_detection/models directory.
...
Example Usage:
--------------
python app.object_detection.models.research.object_detection/export_tflite_ssd_graph.py \
