...
# source: app.object_detection.models.research.object_detection/protos/bipartite_matcher.proto
...
_BIPARTITEMATCHER = _descriptor.Descriptor(
  ...
  full_name=' app.object_detection.models.research.object_detectionprotos.BipartiteMatcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='use_matmul_gather', full_name=' app.object_detection.models.research.object_detectionprotos.BipartiteMatcher.use_matmul_gather', index=0,
...
BipartiteMatcher = _reflection.GeneratedProtocolMessageType('BipartiteMatcher', (_message.Message,), {
  ...
  '__module__' : ' app.object_detection.models.research.object_detectionprotos.bipartite_matcher_pb2'
  # @@protoc_insertion_point(class_scope: app.object_detection.models.research.object_detectionprotos.BipartiteMatcher)
  })
