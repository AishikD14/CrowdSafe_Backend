...
# source: app.object_detection.models.research.object_detection/protos/mean_stddev_box_coder.proto
...
_MEANSTDDEVBOXCODER = _descriptor.Descriptor(
  ...
  full_name=' app.object_detection.models.research.object_detectionprotos.MeanStddevBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stddev', full_name=' app.object_detection.models.research.object_detectionprotos.MeanStddevBoxCoder.stddev', index=0,
...
MeanStddevBoxCoder = _reflection.GeneratedProtocolMessageType('MeanStddevBoxCoder', (_message.Message,), {
  ...
  '__module__' : ' app.object_detection.models.research.object_detectionprotos.mean_stddev_box_coder_pb2'
  # @@protoc_insertion_point(class_scope: app.object_detection.models.research.object_detectionprotos.MeanStddevBoxCoder)
  })
