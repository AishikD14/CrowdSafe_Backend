...
# source: app.object_detection.models.research.object_detection/protos/model.proto
...
from  app.object_detection.models.research.object_detectionprotos import faster_rcnn_pb2 as object__detection_dot_protos_dot_faster__rcnn__pb2
from  app.object_detection.models.research.object_detectionprotos import ssd_pb2 as object__detection_dot_protos_dot_ssd__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a)object_detection/protos/faster_rcnn.proto\x1a!object_detection/protos/ssd.proto\"\xcc\x01\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01 \x01(\x0b\x32#. app.object_detection.models.research.object_detectionprotos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02 \x01(\x0b\x32\x1c. app.object_detection.models.research.object_detectionprotos.SsdH\x00\x12H\n\x12\x65xperimental_model\x18\x03 \x01(\x0b\x32*. app.object_detection.models.research.object_detectionprotos.ExperimentalModelH\x00\x42\x07\n\x05model\"!\n\x11\x45xperimentalModel\x12\x0c\n\x04name\x18\x01 \x01(\t'
  ,
...
_DETECTIONMODEL = _descriptor.Descriptor(
  name='DetectionModel',
  full_name=' app.object_detection.models.research.object_detectionprotos.DetectionModel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='faster_rcnn', full_name=' app.object_detection.models.research.object_detectionprotos.DetectionModel.faster_rcnn', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ssd', full_name=' app.object_detection.models.research.object_detectionprotos.DetectionModel.ssd', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experimental_model', full_name=' app.object_detection.models.research.object_detectionprotos.DetectionModel.experimental_model', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='model', full_name=' app.object_detection.models.research.object_detectionprotos.DetectionModel.model',
...
_EXPERIMENTALMODEL = _descriptor.Descriptor(
  ...
  full_name=' app.object_detection.models.research.object_detectionprotos.ExperimentalModel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name=' app.object_detection.models.research.object_detectionprotos.ExperimentalModel.name', index=0,
...
DetectionModel = _reflection.GeneratedProtocolMessageType('DetectionModel', (_message.Message,), {
  ...
  '__module__' : ' app.object_detection.models.research.object_detectionprotos.model_pb2'
  # @@protoc_insertion_point(class_scope: app.object_detection.models.research.object_detectionprotos.DetectionModel)
  })
...
ExperimentalModel = _reflection.GeneratedProtocolMessageType('ExperimentalModel', (_message.Message,), {
  ...
  '__module__' : ' app.object_detection.models.research.object_detectionprotos.model_pb2'
  # @@protoc_insertion_point(class_scope: app.object_detection.models.research.object_detectionprotos.ExperimentalModel)
  })
